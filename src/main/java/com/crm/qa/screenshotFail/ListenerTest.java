package com.crm.qa.screenshotFail;
...
public class ListenerTest extends BaseClass implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		TakesScreenshot snap = (TakesScreenshot) wd;
		File src = snap.getScreenshotAs(OutputType.FILE);
		try {
			org.openqa.selenium.io.FileHandler.copy(src, new File(
					"C:\\Users\\RAJAT\\eclipse-workspace new\\GITCHECK\\test-output\\Screenshot Failed\\Test.jpg"));
		} catch (IOException e) {
